...
| [0028](0028-unload-backstop-in-localstorage-replayed-at-edit-time.md) | Edits not yet in IndexedDB are parked in localStorage on unload and replayed at edit time | Accepted |
